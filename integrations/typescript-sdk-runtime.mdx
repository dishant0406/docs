...
<CardGroup cols={2}>
  <Card title="Setup Guide" icon="box-open" href="/integrations/typescript-sdk">
    Install `@whyops/sdk`, create the client, patch providers, and configure hosted or self-hosted endpoints.
  </Card>
  <Card title="Manual Events API" icon="code" href="/integrations/manual-events">
    Compare the TypeScript helpers with the raw ingest endpoint and event schema.
  </Card>
</CardGroup>
