...
description: "Register agents, create versioned configurations, and understand how WhyOps binds traces to agent versions when you are using the raw API directly."
---
