...
<CardGroup cols={2}>
  <Card title="Setup Guide" icon="box-open" href="/integrations/python-sdk">
    Install `whyops`, create the client, patch providers, and configure hosted or self-hosted endpoints.
  </Card>
  <Card title="Manual Events API" icon="code" href="/integrations/manual-events">
    Compare the Python helpers with the raw REST ingest endpoint and event schema.
  </Card>
</CardGroup>
