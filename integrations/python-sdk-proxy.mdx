...
| `OPENAI_API_KEY` | Usually your app environment during client creation | Lets you instantiate the OpenAI SDK client before the helper patches it |
| `ANTHROPIC_API_KEY` | Usually your app environment during client creation | Lets you instantiate the Anthropic SDK client before the helper patches it |
...
<Tabs>
  ...
  <Tab title="Async">
    ...
    client = sdk.anthropic(AsyncAnthropic(api_key="YOUR_ANTHROPIC_API_KEY"))
